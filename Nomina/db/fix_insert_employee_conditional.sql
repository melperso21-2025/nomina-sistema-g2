-- ═══════════════════════════════════════════════════════════════════════════
-- SCRIPT: Actualizar sp_insert_employee_conditional
-- Descripción: Asegura que is_active=1 al crear empleado
-- ═══════════════════════════════════════════════════════════════════════════

DROP PROCEDURE IF EXISTS sp_insert_employee_conditional;
GO
...
BEGIN
    ...
    BEGIN TRY
        ...
        -- Insertar empleado con is_active = 1
        ...
        DECLARE @context VARBINARY(128) = CONVERT(VARBINARY(128), @p_user_session, 1);
...
PRINT 'Procedimiento sp_insert_employee_conditional actualizado.';
PRINT 'Ahora garantiza que is_active=1 al crear empleados.';
