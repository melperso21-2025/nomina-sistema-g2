-- ═══════════════════════════════════════════════════════════════════════════
-- SCRIPT: Nuevo procedimiento sp_insert_employee_conditional
-- Descripción: Registra empleado y opcionalmente crea usuario si requiere acceso
-- ═══════════════════════════════════════════════════════════════════════════
...
PRINT 'Procedimiento sp_insert_employee_conditional creado exitosamente.';
PRINT 'Ahora los empleados pueden crearse CON o SIN acceso al sistema.';
