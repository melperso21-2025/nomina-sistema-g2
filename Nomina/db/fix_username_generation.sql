-- ═══════════════════════════════════════════════════════════════════════════
-- SCRIPT: Corregir generación automática de username
-- Descripción: Modifica sp_insert_full_employee para generar username 
--              automáticamente en formato nombre.apellido (minúsculas)
-- ═══════════════════════════════════════════════════════════════════════════
...
BEGIN
    ...
    BEGIN TRY
        ...
        -- Insertar usuario con username generado automáticamente: nombre.apellido en minúsculas
...
PRINT 'Procedimiento sp_insert_full_employee actualizado con generación automática de username.';
PRINT 'Nuevo formato: nombre.apellido (minúsculas)';
