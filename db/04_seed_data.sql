...
VALUES 
(1005, 'ismael.vanegas', HASHBYTES('SHA2_256', 'admin123'), 'Admin'),
(1001, 'israel.arevalo', HASHBYTES('SHA2_256', 'admin123'), 'RRHH'),
(1002, 'alexandra.cai',  HASHBYTES('SHA2_256', 'admin123'), 'RRHH'),
(1003, 'diego.simbana',  HASHBYTES('SHA2_256', 'admin123'), 'Admin'),
(1004, 'lizbeth.chac',   HASHBYTES('SHA2_256', 'admin123'), 'RRHH');
GO
